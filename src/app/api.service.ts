...
//     return this.http.get<IMovie[]>(this.userURI + `GetFavoriteMovies/${user.userId}`).subscribe((movies)=>{
//       if(movies){
//         this.loggedInUser = {
//           User: user,
...
//     return this.http.get<IShow[]>(this.userURI + `GetFavoriteShows/${user.userId}`).subscribe((shows)=>{
//       if(shows){
//         this.loggedInUser = {
//           User: user,
//           FavoriteMovies: [],
...
//           FavoriteShows: []
//         };
//         this.getLoggedInUserFavoriteMovies(x);
//         // this.getLoggedInUserFavoriteShows(x);
//         // this.loggedInEvent.emit(this.giveCurrentUser() as ILoggedInUser);
